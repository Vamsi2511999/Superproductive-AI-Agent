...
def test_ai_engine():
    ...
    print(f"[OK] Extracted {len(email_tasks)} task(s)\n")
    ...
    print(f"[OK] Extracted {len(teams_tasks)} task(s) from Teams\n")
    ...
    print("\n[RESULT] Your AI Agent is 100% FREE and fully operational!")
